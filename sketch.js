...
'https://storage.ning.com/topology/rest/1.0/file/get/10674210662?profile=original'
]
...
if (settings.rotate == false && settings.emojis == true)  {
    imageMode(CENTER);
    image(agent.spritesEmojis, 0, 0, settings.size, settings.size);
  }
